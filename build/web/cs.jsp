<%-- 
    Document   : cs
    Created on : Nov 18, 2018, 5:16:21 PM
    Author     : naman
--%>
...
<html>
    ...
    <body>
        <div class="side-bar">
            ...
            <br>
            <a href="cs.jsp"><h3  class="active">Computer Science</h3></a>
            <br>
        ...
        <div class="bottom-bar">
            ...
            <div class="pro"><br><br> 
            <table border="0" width="670px" height="100px" cellspacing="10px" style="margin-left:90px;color:white;">
            <col width="80">
